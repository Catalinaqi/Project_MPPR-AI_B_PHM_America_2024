# src/phm_america_2024/common/context_facade_common.py
"""
=============================================================================
...
class RunContext:
    ...
    def phase2_dir(self) -> Path:
        return self.get_phase_dir(Phase.PHASE2.value)

    @property
    def phase3_dir(self) -> Path:
        return self.get_phase_dir(Phase.PHASE3.value)

    @property
    def phase4_dir(self) -> Path:
        return self.get_phase_dir(Phase.PHASE4.value)

    @property
    def phase5_dir(self) -> Path:
        return self.get_phase_dir(Phase.PHASE5.value)
