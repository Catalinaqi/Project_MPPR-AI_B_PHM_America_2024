...
class ReadStrategyContract:
    ...
    @classmethod
    def full_strategy(cls) -> "ReadStrategyContract":
        """Pre‑built contract for full (no sampling) CSV load."""
        return cls(mode=ReadMode.FULL)
    ...
    def from_dict(
        ...
        join_key: Optional[str]  = raw.get("join_key") or None
...
class DataSourceConfig:
    ...
    *how* to load it (``ReadStrategyContract``). Passed as a single unit
    ...
    x_validation_path: Optional[str] = None
