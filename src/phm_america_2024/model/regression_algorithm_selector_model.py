...
def single_probabilistic_architecture(
    ...
    model_cfg: dict[str, Any] = {
        ...
        "minibatch_frac_uncertainty": params["minibatch_frac_uncertainty"],
        "minibatch_frac": params["minibatch_frac"],
        "Base": {
            "type": base_params["type"],
            "max_depth_uncertainty": base_params["max_depth_uncertainty"],
            "max_depth": base_params["max_depth"],
            "min_samples_leaf_uncertainty": base_params["min_samples_leaf_uncertainty"],
    ...
    trace: dict[str, Any] = {
        ...
        "model_configured": {
            "Dist": params["Dist"],
            "Score": params["Score"],
            "n_estimators_uncertainty": model_cfg["n_estimators_uncertainty"],
            "n_estimators": model_cfg["n_estimators"],
            "learning_rate_uncertainty": model_cfg["learning_rate_uncertainty"],
            "learning_rate": model_cfg["learning_rate"],
            "minibatch_frac_uncertainty": model_cfg["minibatch_frac_uncertainty"],
            "minibatch_frac": model_cfg["minibatch_frac"],
            "Base": {
                "type": model_cfg["Base"]["type"],
                "max_depth_uncertainty": model_cfg["Base"]["max_depth_uncertainty"],
                "max_depth": model_cfg["Base"]["max_depth"],
                "min_samples_leaf_uncertainty": model_cfg["Base"]["min_samples_leaf_uncertainty"],
